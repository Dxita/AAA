...
public class ShowKPIActivity extends BaseActivity {
    ...
    private void setLineData(RegisteredUserKPI.Data data) {
        ...
        for (int i = 0; i < data.getEmpdata().size(); i++) {
            ...
            /*y.add(new Entry(Integer.parseInt(AppUtils.getRandomNumberString()), Integer.parseInt(empdatum.getAMonth())));
            z.add(new Entry(Integer.parseInt(AppUtils.getRandomNumberString()), Integer.parseInt(empdatum.getAMonth())));*/
