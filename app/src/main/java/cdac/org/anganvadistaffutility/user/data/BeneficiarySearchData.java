...
public class BeneficiarySearchData {
    ...
    public static class Data implements Parcelable {
        ...
        @Expose
        private String tjmDistId;
        @SerializedName("tjm_project_id")
        @Expose
        private String tjmProjectId;
        @SerializedName("tjm_sector_id")
        @Expose
        private String tjmSectorId;
        ...
        protected Data(Parcel in) {
            ...
            tjmDistId = in.readString();
            tjmProjectId = in.readString();
            tjmSectorId = in.readString();
            ...
            tjmDeliveryDate = in.readString();
            tjmLastModifiedDate = in.readString();
            tjmIpAddress = in.readString();
        ...
        public String getTjmDistId() {
            return tjmDistId;
        }

        public void setTjmDistId(String tjmDistId) {
            this.tjmDistId = tjmDistId;
        }

        public String getTjmProjectId() {
            return tjmProjectId;
        }

        public void setTjmProjectId(String tjmProjectId) {
            this.tjmProjectId = tjmProjectId;
        }

        public String getTjmSectorId() {
            return tjmSectorId;
        }

        public void setTjmSectorId(String tjmSectorId) {
        ...
        public String getTjmDeliveryDate() {
            return tjmDeliveryDate;
        }

        public void setTjmDeliveryDate(String tjmDeliveryDate) {
        ...
        public String getTjmIpAddress() {
            return tjmIpAddress;
        }

        public void setTjmIpAddress(String tjmIpAddress) {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeString(tjmDistId);
            dest.writeString(tjmProjectId);
            dest.writeString(tjmSectorId);
            ...
            dest.writeString(tjmDeliveryDate);
            dest.writeString(tjmLastModifiedDate);
            dest.writeString(tjmIpAddress);
