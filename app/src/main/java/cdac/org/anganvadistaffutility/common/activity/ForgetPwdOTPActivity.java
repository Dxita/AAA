...
import cdac.org.anganvadistaffutility.user.activity.ResetPasswordActivity;

public class ForgetPwdOTPActivity extends BaseActivity implements OtpReceivedInterface, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forget_pwd_o_t_p);
        ...
        if (view.getId() == R.id.btnVerifyOtp) {
            if (et_input_otp.getText().toString().isEmpty()) {
                ...
                if (et_input_otp.getText().toString().equalsIgnoreCase(appPreferences.getSavedOtp())) {
                    ...
                    startActivity(new Intent(context, ResetPasswordActivity.class).putExtra("mobile_number", mobileNumber));
                    finish();
                } else {
            ...
            if (AppUtils.isNetworkConnected(context)) {
                ...
                sendOtpToServerPublic(relativeLayout, mobileNumber, AppUtils.getRandomNumberString());
            } else {
